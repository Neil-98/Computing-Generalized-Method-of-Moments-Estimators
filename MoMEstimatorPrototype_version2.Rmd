...
binomial <- function(theta, sample_data) { # Theta = MoM estimates to be found
  ...
  mean_moment_condition <- theoretical_mean - sample_data
  variance_moment_condition <- theoretical_variance  - (sample_data - theoretical_mean) ^ 2
  
  moment_conditions <- cbind(mean_moment_condition, variance_moment_condition)
...
poisson <- function(theta, sample_data) { # Theta = MoM estimates to be found
  ...
  moment_conditions <- cbind(mean_moment_condition)
  return(moment_conditions)
}
```
...
# Multinomial
multinomial <- function(theta, sample_data) { # Theta = MoM estimates to be found
...
# Multivariate normal
multivariate_normal <- function(theta, sample_data) { # Theta = MoM estimates to be found
  return(moments)
}
